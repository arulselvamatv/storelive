...
$HTML="";
	if($con)
	{
	  ...
	  <tbody id="tbody">';
        ...
        Terms and Conditions<span style='color:red'>*</span>:<input class='form-control' type='text' id='term_cond' name='term_cond' required/>
        </th>
        <th>
        Remarks<span style='color:red'>*</span>:<input class='form-control' type='text' id='remarks' name='remarks' required/>
