...
$(document).on('click', '.view', function( e ) {
	...
	$("#update_div").html("");
		...
		$("#update_div").html("<table width='100%'><tr><td align='center'><a class=\"btn btn-primary\" href=delivery_slip_preview.php?pid="+splt_this_id_ar+" target='_blank'> Click here to print</a> </td></tr></table>");
