                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-bordered" style="font-size:inherit!important;" id="trn_dlr_pi_inv">
                                                  ...
                                                  <thead>
                                                    ...
                                                    <th class="test-center">Work Order Number</th>
                                                  ...
                                                  $asd =('SELECT s.company_name,`wo_id`, dep_no,`bill_type`, `po_no`, `wo_no`, `quo_no`, `prod_name`, `ddl_pro_unit`, `ddl_pro_qty`, `product_spec`, `suplier_id`, `sup_amt`, `disc_amt`, `tot`,`postatus`,`poreason`, work_order.`active_record`, work_order.`date_time` FROM `work_order` 

                                                    inner join suplier as s on s.sup_id = work_order.suplier_id WHERE work_order.`active_record`=1  group by po_no order by work_order.`current_date_time` desc ');
                                                    ...
                                                    while($prd = $prdt_data->fetch(PDO::FETCH_ASSOC)){ 
                                                        ...
                                                        '<center>'.$prd['quo_no'].'</center>'.

                                                        '</th>'.
                                                        
                                                        '<th>'.
                                                        
                                                        '<center>'.$prd['wo_no'].'</center>'.
