...
?>
                                    ...
                                    <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <option value="">Select A Quotation NO</option>
                                                            ...
                                                            $asd =('SELECT  `serial_no` FROM `quotation` WHERE active_record=1 group by (`serial_no`) order by serial_no desc ');
                                                        ...
                                                        <select class="js-example-basic-multiple" size="50" name="suplier_name"  id="suplier_name" disabled>
                                                        ...
                                                        <option value="">Select A Supplier</option>
                                                            ...
                                                            while($data=$datd->fetch(PDO::FETCH_ASSOC))

                                                                {
                                                                    ...
                                                                    echo "<option value='".$data['sup_id']."' data-name='".$data['name']."'>".''.$data['name']." ( ".$data['company_name'].")</option>";
    ...
    <script>
            ...
            $( document ).ready(function() {
                ...
                var tot_price = (Number(discount * gst / 100) + Number(discount)).toFixed(2);
...

                                    {
...

                                        {
...

                                            {
                                                ...
                                                window.location="quotion_amount.php";
