				...
				<div class="col-sm-12">
					<div class="card">
                        <div class="card-header bg-info">
                            <h4 class="mb-0 text-white">GRB Verification Slip</h4>
                        </div>
...
<div id="update_div"></div>
                    ...
                    //echo $asd; exit;
                    $datd = $db->query($asd);
                    echo'<div class="px-4 py-4"><hr /><table id="trn_dlr_pi_inv" style="border-collapse:collapse; width:100%;"  cellpadding="5" class="table table-responsive">';
                    echo "<thead><tr>";
                    echo "<th>S.No.</th>";
                    echo "<th>GRB No.</th>";
