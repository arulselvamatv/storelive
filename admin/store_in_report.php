...
?>
                            ...
                            <form autocomplete="off">
                                ...
                                <div class="form-body">
                                    <div class="card-body">
                                        ...
                                        <div class="card-header bg-info">
                                            <h4 class="mb-0 text-white">Store In Report By Date</h4>
                                        </div>
                                        <div class="row pt-3">  
                                            <!--/span-->
                                            <div class="table-responsive">
    ...
    // $(document).on('change', '#po_no', function( e ) {
        ...
        $.ajax({
				type: "GET",
				url: 'ajax/ajax_store_in_report.php?po_no='+this_val,
            ...
            $.ajax({
				type: "GET",
				url: 'ajax/ajax_store_in_date_report.php?po_no='+this_val,
				success: function(data){
					//alert(data);
                    $('#tbody').html(data);
