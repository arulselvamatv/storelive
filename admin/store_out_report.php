...
?>
                            ...
                            <form autocomplete="off">
                                ...
                                <div class="form-body">
                                    <div class="card-body">
                                                ...
                                                <table class="table table-bordered" id="trn_dlr_pi_inv">
                                                  <thead>
                                                    <tr>
                                                      ...
                                                      <th class="text-center">Print Barecode.</th>
                                                    </tr>
                                                  </thead>
                                                  <tbody id="tbody1">
                                        ...
                                        <div class="card-header bg-info">
                                            <h4 class="mb-0 text-white">Store Out Report By Date</h4>
                                        </div>
                                        <div class="row pt-3">  
                                            <!--/span-->
                                            <div class="table-responsive">
                                                <table class="table table-bordered" id="trn_dlr">
                                                  <thead>
                                                    <tr>
                                        ...
                                        <div class="card-header bg-info">
                                            <h4 class="mb-0 text-white">Store Out Report By Department</h4>
                                        </div>
                                        <div class="row pt-3">  
                                            <!--/span-->
                                            <div class="table-responsive">
                                                <table class="table table-bordered" id="trn">
                                                  <thead>
                                                    <tr>
                                                    <th class="text-center">S.NO.</th>
                                                      <th class="text-center">Department Name.</th>
    ...
    // $(document).on('change', '#po_no', function( e ) {
        ...
        $.ajax({
				type: "GET",
				url: 'ajax/ajax_store_out_report.php?po_no='+this_val,
            ...
            $.ajax({
				type: "GET",
				url: 'ajax/ajax_store_out_date_report.php?po_no='+this_val,
				success: function(data){
					//alert(data);
                    $('#tbody').html(data);
            ...
            $.ajax({
				type: "GET",
				url: 'ajax/ajax_store_out_dept_report.php?po_no='+this_val,
				success: function(data){
					//alert(data);
                    $('#tbod').html(data);
