...
<body>
  ...
  <div id="login-page">
    <div class="container">
      <form name="ulogin" method="post" class="form-login" action="login_action.php">
        <h2 class="form-login-heading"><a href='login.php' style='color:#fff'> sign in now </a> </h2>
        <div class="login-wrap">
		  ...
		  <button class="btn btn-primary btn-block" name="user_login" type="submit"> <i class="fa fa-lock"></i>  SIGN IN</button>
		  ...
		  <p><br/> </p>
          <!--
		  <button class="btn btn-theme btn-block" name="user_login" type="submit"> SIGN IN</button>
		  <hr>
