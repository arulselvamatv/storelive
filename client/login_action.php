...

{
	...
	$dbsel_q1 = $db->query("select * from clientusers where email='$user_name' and pass='$user_pass' and status='1'") or die("select query not working");
...

	{
		...
		$log_update = $db->query("update clientusers set log_status='1',login_ip='$ip_address',last_login='$log_date' where id='$user_id'") or die("login date and time update not working!");
