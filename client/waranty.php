                    ...
                    <div class="col-lg-12">
                        <div class="card"></br>
                            ...
                            <div class="card-header bgclr">
                                <h4 class="mb-0 text-white">Waranty List</h4>
                            </div>
                                ...
                                WHERE wo.`active_record` =1 and s.`active_record` =1 and st.dep!=0 and st.tranf = 0 and cu.email="'.$user_id.'" group by st.se_no');
                                //echo $asd; exit;
                                $datd = $db->query($asd);
